...
We as members, contributors, and leaders pledge to make participation in the sk_pgp
...
- Focusing on what is best not just for us as individuals, but for the overall
  community
- For a security-critical project: reporting vulnerabilities responsibly and
  privately (see [SECURITY.md](SECURITY.md)), and holding crypto claims to an honest,
  evidence-backed standard rather than to hype
...
- Knowingly making false or unverifiable security/cryptography claims, or pressuring
  others to do so
...
the community leaders responsible for enforcement (smilinTux / the sk_pgp
maintainers) through the project's private contact channel. All complaints will be
